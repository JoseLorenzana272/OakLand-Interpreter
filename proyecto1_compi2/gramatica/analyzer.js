...
function peg$parse(input, options) {
  ...
  var peg$f7 = function(expressions) { return createNode('Print', {exp: expressions}); };
  var peg$f8 = function(head, tail) { return [head, ...tail.map(t => t[3])]; };
  var peg$f9 = function() { return createNode('Literal', {value: parseInt(text()), type: 'int'}); };
  var peg$f10 = function() { return createNode('Literal', {value: parseFloat(text(), 10), type: 'float'}); };
  var peg$f11 = function() { return createNode('Literal', {value: text() === "true" ? true : false, type: 'bool'}); };
  var peg$f12 = function() { return createNode('Literal', {value: text().slice(1,-1), type: 'string'}); };
  var peg$f13 = function() { return createNode('Literal', {value: text().slice(1,-1), type: 'char'}); };
  var peg$f14 = function() { return createNode('Literal', {value: null, type: 'null'}); };
